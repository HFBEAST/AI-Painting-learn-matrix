...
# 指定配置文件
# Z:\\AI\\2333\\mmclassification-master\\mmclassification-master\\configs\\resnet\\resnet18_8xb32_in1k.py
def parse_args():
    parser = argparse.ArgumentParser(description='Train a model')
    parser.add_argument('config', help='train config file path')  # 'config' 配置文件内的默认参数
